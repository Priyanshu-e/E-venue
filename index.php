...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		echo "<script>alert('Venue has been added to the cart')</script>";
...
<html lang="en">
	<head>
	    ...
	    <title>Venue Management Home Page</title>
...
<div id="hero" class="homepage-slider3">
	...
	<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/41.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/17.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		<div class="full-width-slider">	
...
<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/32.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	</div><!-- /.owl-carousel -->
</div>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">EASY REFUND. CANCEL VENUE IF YOU ARE NOT SATISFIED</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">free service</h4>
						</div>
					</div>
					<h6 class="text">free 24*7 hour service-on venue booked by you</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Special Discount</h4>
						</div>
					</div>
					<h6 class="text">All venue-discount up to 20% off </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Venues</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">All</a></li>
					<li><a href="#books" data-toggle="tab">Wedding Venue</a></li>
					<li><a href="#furniture" data-toggle="tab">Bride section</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
?>
	...
	<div class="product">		
		...
		<?php if($row['productAvailability']=='In Stock'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-danger">Book Now</a></div>
				<?php } else {?>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Groom</h3>
	                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	   
<?php
$ret=mysqli_query($con,"select * from products where category=6 and subCategory=12");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Bride</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
