...
if(!empty($_SESSION['cart'])){
		foreach($_POST['remove_code'] as $key){
			...
			echo "<script>alert('Your Venue Cart has been Updated');</script>";
	}
}
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-product-name item">Venue Name</th>
			
					<th class="cart-qty item"></th>
					<th class="cart-sub-total item">Venue Price</th>
					<th class="cart-sub-total item">TAX</th>
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-danger outer-left-xs">Continue Booking More Venues</a>
								<input type="submit" name="submit" value="Update Venue cart" class="btn btn-upper btn-danger pull-right outer-right-xs">
							</span>
...
?>
					...
					<td class="cart-product-quantity">
						<div class="quant-input">
				             <input type="hidden" type="text" value="<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?>" name="quantity[<?php echo $row['id']; ?>]">
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-danger checkout-page-button">Update</button>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-danger">PROCCED TO PAYMENT</button>
