...
<div class="logo">
	<a href="index.php">
		...
		<h2>VenueManagement</h2>

	</a>
</div>		
</div>
<div class="col-xs-12 col-sm-12 col-md-6 top-search-holder" >
<div class="search-area" id ="new-search" >
    <form name="search" method="post" action="search-result.php">
        <div class="control-group" style="background:white">

            <input class="search-field" placeholder="Search here..." name="product" required="required"/>

            <button class="search-button" type="submit" name="search"id="new-btn"></button>    
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price">Rs.<?php echo ($row['productPrice']+$row['shippingCharge']); ?></div>
							<!-- *<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div> -->
						</div>
...
<div class="dropdown dropdown-cart">
		...
		<ul class="dropdown-menu">
			...
			<div class="clearfix cart-total">
				...
				<a href="index.php" class="btn btn-upper btn-primary btn-block m-t-20">Continue Booking</a>	
			</div><!-- /.cart-total-->
