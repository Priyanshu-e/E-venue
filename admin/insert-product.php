...
<head>
	...
	<title>Admin| Insert Venue</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Venue Name</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Venue Owner</label>
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Enter Product Comapny Name" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Venue Price Before Discount</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Venue Price After Discount(Selling Price)</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Venue Description</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Venue Additional Charge</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Venue Availability</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Venue Image1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Venue Image2</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Venue Image3</label>
<div class="controls">
