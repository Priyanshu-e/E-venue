...
<div class="control-group">
<label class="control-label" for="basicinput">Current Venue Image1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">New Venue Image1</label>
<div class="controls">
