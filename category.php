...
echo "<script>alert('Venue added in wishlist');</script>";
...
<html lang="en">
	<head>
	    ...
	    <meta name="keywords" content="MediaCenter, Template, eCommerce, VenueManagement System">
	    <meta name="robots" content="all">

	    <title>Venue Category</title>
...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div class="head" style="background:#dc143c"><i class="icon fa fa-align-justify fa-fw"></i>Sub Categories</div>        
...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 class="section-title" >Search by</h3>
	            	<div class="sidebar-filter">
		            	<!-- ============================================== SIDEBAR CATEGORY ============================================== -->
<div class="sidebar-widget wow fadeInUp outer-bottom-xs " >
	<div class="widget-header m-t-20" style="background:#dc143c">
...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/cate1.jpg" alt="" class="img-responsive">
			</div>
...
{?>							
	...
	<div class="product">		
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<button class="btn btn-danger" type="button">Book Now</button></a>
								<?php } else {?>
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>No Venue Found</h3>
		</div>
